...
*/
    ...
    function simpleShader(shader, uniforms, textureIn, textureOut) { (textureIn || this._.texture).use();
...
*/
    ...
    exports.canvas = function() {
        ...
        canvas.watter = wrap(watter);
        canvas.threshold = wrap(threshold);
        canvas.invertColor = wrap(invertColor);
        canvas.outlineInk = wrap(outlineInk);
        canvas.mirror = wrap(mirror);
        // Atomics
        canvas.brightness = wrap(brightness);
        ...
        canvas.incrustStep1 = wrap(incrustStep1);
        canvas.incrustStep1b = wrap(incrustStep1b);
        canvas.incrustStep1c = wrap(incrustStep1c);
        canvas.incrustStep2 = wrap(incrustStep2);
        canvas.incrustStep2b = wrap(incrustStep2b);
        canvas.incrustStep3 = wrap(incrustStep3);
 ...
 */
    function brightness(brightness) {
        gl.brightness = gl.brightness || new Shader(null, '\
        uniform sampler2D texture;\
    ...
    ');
        ...
        simpleShader.call(this, gl.brightness, {
 ...
 */
    ...
    ');
        ...
        simpleShader.call(this, gl.contrast, {
            contrast: clamp( - 1, contrast, 1)
            });
